...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const query_subscriptions = 'INSERT INTO subs (creator_id, text, upload, rules_id, status) VALUES ($1, $2, $3, $4, $5) RETURNING invite_id ';
        const results_subscriptions = await db.query(query_subscriptions, [creator_id, text, upload, rules_id, 'available']);
